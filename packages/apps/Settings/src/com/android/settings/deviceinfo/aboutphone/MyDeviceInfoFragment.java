...
import com.android.settings.deviceinfo.SerialNoPreferenceController;
...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    protected List<AbstractPreferenceController> createPreferenceControllers(Context context) {
		...
		/*String keyCode = SystemProperties.get("ro.serialno");

		Preference preference = findPreference("key_serial_number");
		preference.setSummary(keyCode);*/
		//Log.d("ykq", "createPreferenceControllers");
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(
		...
		controllers.add(new SerialNoPreferenceController(context));
        return controllers;
    }
