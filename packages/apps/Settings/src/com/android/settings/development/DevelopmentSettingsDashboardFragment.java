...
public class DevelopmentSettingsDashboardFragment extends RestrictedDashboardFragment
    ...
    @Override
    public void onEnableWifiAdbDialogConfirmed() {
        final WifiAdbPreferenceController controller = getDevelopmentOptionsController(
                WifiAdbPreferenceController.class);
        controller.onWifiAdbDialogConfirmed();

    }

    @Override
    public void onEnableWifiAdbDialogDismissed() { 
        final WifiAdbPreferenceController controller = getDevelopmentOptionsController(
                WifiAdbPreferenceController.class);
        controller.onWifiAdbDialogDismissed();
    }
    ...
    private static List<AbstractPreferenceController> buildPreferenceControllers(Context context,
        ...
        controllers.add(new WifiAdbPreferenceController(context, fragment));
