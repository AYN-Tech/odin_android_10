...
public class SpecialCharSequenceMgr {
  ...
  private final static String cmd_15 = "echo 15 > /sys/devices/soc0/select_image";
  ...
  //andrew.hu add RPM TZ SBL version start
   ...
   private static void showQuectelImagePanel(Context context,TelephonyManager telephonyManager) {
       ...
       resetModemCl(cmd_15,false);
       String select_image_15 = resetModemCl(cmd_cat,true);
       ...
       if(select_image_11.contains("SC66W")){
           select_image_11 = select_image_11.replace("SC66W_","");
       }
       String baseVersion = "";
       try {
