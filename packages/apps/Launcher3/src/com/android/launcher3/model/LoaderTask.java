...
public class LoaderTask implements Runnable {
	...
	private void printAppInfo(List<LauncherActivityInfo> allActivityList){
		for(LauncherActivityInfo appActivityInfo : allActivityList){
			Log.d(TAG, "app info: lable = " + appActivityInfo.getLabel() + "  className = " + appActivityInfo.getComponentName().getClassName() + "  packageName = " + appActivityInfo.getComponentName().getPackageName());
		}
	}
	...
	/*private void verifyApplications() {
        ...
        if (!added.isEmpty()) {
            mApp.getModel().addAndBindAddedWorkspaceItems(context, added);
        }
    }*/
