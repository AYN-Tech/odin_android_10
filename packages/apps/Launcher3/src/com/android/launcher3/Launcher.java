...
public class Launcher extends BaseDraggingActivity implements LauncherExterns,
    ...
    protected void onResume() {
    	Settings.System.putInt(getContentResolver(), Settings.System.FORBID_SHOW_SYSTEM_UI, 0);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
    	//Log.d("ykq--", "dispatchKeyEvent 1" + event.getKeyCode());
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
    	//Log.d(TAG, "keyCode = " + keyCode + "  action = " + event.getAction() + "  mTurnPageFlag = " + mTurnPageFlag);
    	if (keyCode == KeyEvent.KEYCODE_BUTTON_L1 && event.getRepeatCount() == 0) {
			mWorkspace.keyTurnPage(View.FOCUS_LEFT);
        } else if (keyCode == KeyEvent.KEYCODE_BUTTON_R1 && event.getRepeatCount() == 0){
			mWorkspace.keyTurnPage(View.FOCUS_RIGHT);
        }
