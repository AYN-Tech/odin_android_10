...
public class Workspace extends PagedView<WorkspacePageIndicator>
    ...
    public void setInsets(Rect insets) {
        ...
        setPadding(padding.left, padding.top, padding.left, padding.bottom);
	...
	/**
	* Press L1 key to page left and R1 key to page right
	*
	* @param direction can be View.FOCUS_LEFT or View.FOCUS_RIGHT
	*
	* make by @ykq
	*/
	public boolean keyTurnPage(int direction){
		...
		if(result){
			getPageAt(getCurrentPage()).requestFocus(View.FOCUS_RIGHT);
		}
		return result;
	}
