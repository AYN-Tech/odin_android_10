...
public class InvariantDeviceProfile {
    ...
    private InvariantDeviceProfile(InvariantDeviceProfile p) {
		...
		//Log.d(TAG, "InvariantDeviceProfile(InvariantDeviceProfile p) numRows = " + numRows + "  numColumns" + numColumns + "  defaultLayoutId = " + defaultLayoutId);
    }
    ...
    private String initGrid(Context context, String gridName) {
		...
		//Log.d(TAG, "closestProfile.name = " + closestProfile.name);
