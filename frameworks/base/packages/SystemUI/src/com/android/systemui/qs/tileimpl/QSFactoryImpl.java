...
import com.android.systemui.qs.tiles.AtmosphereLampTile;
import com.android.systemui.qs.tiles.LightTile;
import com.android.systemui.qs.tiles.HandleLightTile;
import com.android.systemui.qs.tiles.JoystickLightTile;
...
public class QSFactoryImpl implements QSFactory {
    ...
    private QSTileImpl createTileInternal(String tileSpec) {
        ...
        switch (tileSpec) {
			...
			case "autobrightness":
				return new AutoBrightnessTile(mHost);
			case "fan":
				return new FanTile(mHost);
			case "ledlights":
				return new LightTile(mHost);
			case "handlelight":
				return new HandleLightTile(mHost);
			case "joysticklight":
				return new JoystickLightTile(mHost);
			case "performancemode":
				return new PerformanceTile(mHost);
        }
