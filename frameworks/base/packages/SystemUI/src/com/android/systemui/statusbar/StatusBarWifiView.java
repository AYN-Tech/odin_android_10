...
import com.android.systemui.statusbar.phone.customview.NetworkSpeedIndicatorView;
...
public class StatusBarWifiView extends FrameLayout implements DarkReceiver,
	...
	private boolean mIsShouldShowInOrOut;
	...
	private void initInAndOutFlag(){
		mIsShouldShowInOrOut = Settings.System.getInt(getContext().getContentResolver(), NetworkSpeedIndicatorView.STATUS_BAR_NETWORK_SPEED, 0) == 0;
	}

	private void registerSettingsValueListener(){
        getContext().getContentResolver().registerContentObserver(Settings.System.getUriFor(NetworkSpeedIndicatorView.STATUS_BAR_NETWORK_SPEED), true, new SettingsValueChangeContentObserver());
	}
    ...
    private boolean updateState(WifiIconState state) {
        ...
        mIn.setVisibility(state.activityIn && mIsShouldShowInOrOut ? View.VISIBLE : View.GONE);
        mOut.setVisibility(state.activityOut && mIsShouldShowInOrOut ? View.VISIBLE : View.GONE);
        mInoutContainer.setVisibility((state.activityIn || state.activityOut) && mIsShouldShowInOrOut ? View.VISIBLE : View.GONE);
    ...
    private void initViewState() {
        ...
        mIn.setVisibility(mState.activityIn && mIsShouldShowInOrOut ? View.VISIBLE : View.GONE);
        mOut.setVisibility(mState.activityOut && mIsShouldShowInOrOut ? View.VISIBLE : View.GONE);
        mInoutContainer.setVisibility((mState.activityIn || mState.activityOut) && mIsShouldShowInOrOut ? View.VISIBLE : View.GONE);
	...
	private class SettingsValueChangeContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
			...
			mIsShouldShowInOrOut = Settings.System.getInt(getContext().getContentResolver(), NetworkSpeedIndicatorView.STATUS_BAR_NETWORK_SPEED, 0) == 0;
			updateState(mState.copy());
			//mInoutContainer.setVisibility(mIsShouldShowInOrOut ? View.VISIBLE : View.GONE);
        }
    }
}
