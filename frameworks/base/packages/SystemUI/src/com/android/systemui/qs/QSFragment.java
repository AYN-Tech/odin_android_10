...
public class QSFragment extends LifecycleFragment implements QS, CommandQueue.Callbacks,
    ...
    private void updateQsState() {
		...
		//Log.d("QS_ykq", "mQsExpanded = " + mQsExpanded + "  keyguardShowing = " + keyguardShowing + "  mHeaderAnimating" + mHeaderAnimating + "  mShowCollapsedOnKeyguard = " + mShowCollapsedOnKeyguard);
