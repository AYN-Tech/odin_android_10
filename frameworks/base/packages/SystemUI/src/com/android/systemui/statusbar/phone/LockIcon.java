...
public class LockIcon extends KeyguardAffordanceView implements OnUserInfoChangedListener,
	...
	public void setKeyguardMessageArea(KeyguardMessageArea keyguardMessageArea){
		this.mKeyguardMessageArea = keyguardMessageArea;
	}
    private int getIconForState(int state) {
        ...
        switch (state) {
            ...
            case STATE_LOCK_OPEN:
				...
				if(mKeyguardMessageArea != null){
					mKeyguardMessageArea.setMessage(getContext().getString(R.string.press_a_to_unlock));
				}
                break;
            default:
