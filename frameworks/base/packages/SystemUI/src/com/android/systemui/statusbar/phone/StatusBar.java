...
public class StatusBar extends SystemUI implements DemoMode,
	...
	private static final int MSG_FORBID_SHOW_SYSTEM_UI_VALUE_CHANGED = 20210902;
    ...
    public void start() {
	    ...
	    SettingsValueChangeContentObserver contentOb = new SettingsValueChangeContentObserver();
        mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(Settings.System.FORBID_SHOW_SYSTEM_UI), true, contentOb);
    }
    ...
    protected void inflateStatusBarWindow(Context context) {
		...
		KeyguardMessageArea keyguardMessageArea = mStatusBarWindow.findViewById(R.id.keyguard_message_area);
		keyguardMessageArea.setMessage(context.getString(R.string.press_a_to_unlock));
		LockIcon lockIcon = mStatusBarWindow.findViewById(R.id.lock_icon);
		lockIcon.setKeyguardMessageArea(keyguardMessageArea);
    }
        ...
        public void handleMessage(Message m) {
            switch (m.what) {
                ...
                case MSG_LAUNCH_TRANSITION_TIMEOUT:
                    ...
                    break;
				case MSG_FORBID_SHOW_SYSTEM_UI_VALUE_CHANGED:
					mAutoHideController.immediatelyHide();
					break;
            }
        }
    }
	...
	private class SettingsValueChangeContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange) {
			...
			message.what = MSG_FORBID_SHOW_SYSTEM_UI_VALUE_CHANGED;
