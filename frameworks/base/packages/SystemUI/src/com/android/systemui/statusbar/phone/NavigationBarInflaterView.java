...
public class NavigationBarInflaterView extends FrameLayout
	...
	public static final String KEY_NAVIGATION_HINT = Settings.System.NAVIGATION_BAR_HINT;
    private static final String OVERLAY_NAVIGATION_HIDE_HINT = "org.lineageos.overlay.customization.navbar.nohint";
	...
	private void initIsHintEnabled(){
		mIsHintEnabled = Settings.System.getInt(mContext.getContentResolver(), KEY_NAVIGATION_HINT, 0) == 1;
	}
    ...
    protected String getDefaultLayout() {
		...
		//Log.d(TAG, "getDefaultLayout defaultResource = " + defaultResource);
    ...
    protected void onAttachedToWindow() {
		...
		mContext.getContentResolver().registerContentObserver(Settings.System.getUriFor(KEY_NAVIGATION_HINT), true, mObserver, userId);
    }
    ...
    public void onValueChanged(String key, int newValue) {
    //Log.d(TAG, "onTuningChanged key = " + key + "  newValue" + newValue);
	if (KEY_NAVIGATION_HINT.equals(key)) {
            mIsHintEnabled = newValue == 1;
			Log.d(TAG, "mIsHintEnabled = " + mIsHintEnabled);
            updateHint();
            onLikelyDefaultLayoutChange();
        }
    }
	...
	private class Observer extends ContentObserver {
        ...
        public void onChange(boolean selfChange, Uri uri, int userId) {
            if (userId == ActivityManager.getCurrentUser()) {
				int value = Settings.System.getInt(mContext.getContentResolver(), KEY_NAVIGATION_HINT, 0);
                onValueChanged(KEY_NAVIGATION_HINT, value);
            }
        }
    }
}
