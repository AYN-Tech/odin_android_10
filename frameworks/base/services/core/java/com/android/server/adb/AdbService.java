    ...
    private final class AdbHandler extends Handler {
        AdbHandler(Looper looper) {
            ...
            try {
                 ...
                 * all boot modes.
                 */
				String enable_adb = SystemProperties.get(USB_PERSISTENT_CONFIG_PROPERTY, "");//"sys.usb.config"
                mAdbEnabled = containsFunction(enable_adb, UsbManager.USB_FUNCTION_ADB);
				Slog.d(TAG, "AdbHandler() enable_adb=" + enable_adb + ", mAdbEnabled=" + mAdbEnabled);
