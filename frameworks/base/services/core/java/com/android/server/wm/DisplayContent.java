...
class DisplayContent extends WindowContainer<DisplayContent.DisplayChildWindowContainer>
    ...
    boolean updateRotationUnchecked(boolean forceUpdate) {
        ...
        final int oldRotation = mWmService.mBootAnimationStopped ? mRotation:ROTATION_90;//mRotation;
    ...
    private DisplayInfo updateDisplayAndOrientation(int uiMode, Configuration outConfig) {
        ...
        final int appWidth = mDisplayPolicy.getNonDecorDisplayWidth(dw, dh, mWmService.mBootAnimationStopped ?mRotation:ROTATION_90/*mRotation*/, uiMode,
                displayCutout);
        //final int appHeight = mDisplayPolicy.getNonDecorDisplayHeight(dw, dh, mRotation, uiMode,
        final int appHeight = mDisplayPolicy.getNonDecorDisplayHeight(dw, dh, mWmService.mBootAnimationStopped ?mRotation:ROTATION_90/*mRotation*/, uiMode,
                displayCutout);
    ...
    public void writeToProto(ProtoOutputStream proto, long fieldId,
        ...
        proto.write(ROTATION, mWmService.mBootAnimationStopped ? mRotation:ROTATION_90/*mRotation*/);
