...
public class UsbDeviceManager implements ActivityTaskManagerInternal.ScreenObserver {
    ...
    abstract static class UsbHandler extends Handler {
        ...
        private void setAdbEnabled(boolean enable) {
            ...
            if (enable) {
                setSystemProperty(USB_PERSISTENT_CONFIG_PROPERTY, "diag,adb,serial_cdev");//UsbManager.USB_FUNCTION_ADB
            } else {
                setSystemProperty(USB_PERSISTENT_CONFIG_PROPERTY, "diag,serial_cdev");
            }
