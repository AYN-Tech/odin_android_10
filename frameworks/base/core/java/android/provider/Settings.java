...
public final class Settings {
    ...
    public static final class System extends NameValueTable {
        ...
        /** @hide */
        public static final Validator NAVIGATION_BAR_HINT_VALIDATOR = BOOLEAN_VALIDATOR;

		/**
		* boolean value. forbid swip up or down to show system ui when fullscreen mode.
		* @hide
		*/
		public static final String FORBID_SHOW_SYSTEM_UI = "forbid_show_system_ui";

		/** @hide */
        public static final Validator FORBID_SHOW_SYSTEM_UI_VALIDATOR = BOOLEAN_VALIDATOR;
        ...
        static {
			...
			VALIDATORS.put(FORBID_SHOW_SYSTEM_UI, FORBID_SHOW_SYSTEM_UI_VALIDATOR);
        }
    ...
    public static final class Global extends NameValueTable {
       ...
       public static final String LOW_MEMORY_MODE = "low_memory";
