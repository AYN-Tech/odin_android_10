...
class CursorIconMotionAccumulator {
public:
...
/* needing to fade cursor . */

class CursorIconFadeAccumulator {
public:
    ...
    inline bool getNeedToFade() const { return mNeedTofade; }
...
public:
	...
	inline int32_t getAbsoluteTrackingId() const { return mAbsMTTrackingId; }
...
class CursorIconInputMapper : public InputMapper {
public:
    explicit CursorIconInputMapper(InputDevice* device);
    virtual ~CursorIconInputMapper();
...
private:
    ...
    CursorIconMotionAccumulator mCursorIconMotionAccumulator;
    CursorButtonAccumulator mCursorButtonAccumulator;
    CursorScrollAccumulator mCursorScrollAccumulator;
	CursorIconFadeAccumulator mCursorIconFadeAccumulator;
...
protected:
	...
	virtual bool isVritualMouseId() = 0;
