...
echo "ro.build.display.id=Odin_V${COMPLETE_VERSION}_`date +%Y%m%d_%H%M%S`_$TARGET_BUILD_TYPE"
...
echo "ro.product.model=Odin"
echo "ro.product.brand=google"
echo "ro.product.name=Odin"
...
echo "ro.ayn.ota.version=$COMPLETE_VERSION"
